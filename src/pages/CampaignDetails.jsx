                    ...
                    <div>
                        ...
                        <div className='mt-[20px] flex flex-col gap-4'>
                            ...
                            {donators.length > 0 ? donators.map((item, index) => (
                                <div key={`${item.donator}-${index}`} className='flex justofy-between gap-4 items-center'>
                                ...
                                (
                                    <p className='font-epilogue font-normal text-[16px]
                             text-[#808191] leading-[26px] text-justify'>No donators yet. Be the first one to donate!</p>
                                )
                            }
                        </div>
                    </div>
                        ...
                        <div className='mt-[30px]'>
                            ...
                            <div className='my-[20px] p-4 bg-[#13131a] rounded-[10px]'>
                                ...
                                <p className='mt-[20px] font-epilogue font-normal leading-[22px] text-[#808191]'>
                                    Support the project for no reward, because it speaks to you</p>
                            </div>
